...
function update_canvas() {
    ...
    sketch_random=quick_draw_data_set[random_number];
    console.log(quick_draw_data_set[random_number]);
    document.getElementById("what_you_drawing").innerHTML="Sketch To Be Drawn :"+sketch_random;
}
function setup() {
    ...
    function preload() {
        linkmodel=ml5.imageClassifier("DoodleNet");
    }
   function check_sketch() {
    linkmodel.classify(canvas,gotresults) ;
    }
    function gotresults(error,results) {
        if (error) {
            ...
            console.log(results);
            document.getElementById("sketch_label").innerHTML="Object : "+results[0].label;
            document.getElementById("con").innerHTML="Accuracy : "+Math.round(results[0].confidence*100)+"%";
